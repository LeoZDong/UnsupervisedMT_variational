...
# files full paths
SRC_RAW=$MONO_PATH/small.en
TGT_RAW=$MONO_PATH/small.fr
SRC_TOK=$MONO_PATH/small.en.tok
TGT_TOK=$MONO_PATH/small.fr.tok
BPE_CODES=$MONO_PATH/bpe_codes_small
CONCAT_BPE=$MONO_PATH/small.en-fr.$CODES
SRC_VOCAB=$MONO_PATH/vocab_small.en.$CODES
TGT_VOCAB=$MONO_PATH/vocab_small.fr.$CODES
FULL_VOCAB=$MONO_PATH/vocab_small.en-fr.$CODES
