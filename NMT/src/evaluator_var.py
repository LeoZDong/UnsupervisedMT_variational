...
class EvaluatorMT(object):
    ...
    def __init__(self, trainer, data, params):
        ...
        self.latent = trainer.latent
        self.latent_joint = trainer.latent_joint
    ...
    def eval_para(self, lang1, lang2, data_type, scores):
        ...
        for batch in self.get_iterator(data_type, lang1, lang2):
            ...
            mu, var = self.latent(encoded.enc_hiddens, lang1_id)
            latent_resampled = self.latent.reparameterize(mu, var)
            decoded, _ = self.decoder(encoded, latent_resampled, sent2[:-1], lang2_id)
            sent2_, len2_, _ = self.decoder.generate(encoded, latent_resampled, lang2_id)
    ...
    def eval_back(self, lang1, lang2, lang3, data_type, scores):
        ...
        for batch in self.get_iterator(data_type, lang1, lang3):
            ...
            decoded, _ = self.decoder(encoded, latent_resampled_2, sent3[:-1], lang3_id)
